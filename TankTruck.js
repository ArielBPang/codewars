...
tankvol(80,120,3500) //should return 2478 (calculation gives about: 2478.73
...
function tankvol(h, d, vt) {
  ...
  if(h==radius){
    ...
    var angle = Math.acos((radius-h)/radius);
    var slice_volume = ((angle*2)/(Math.PI*2))*vt;
    var b = Math.sin(angle)*radius;
    var triangle_area = b*(radius-h);
    var circle_area = Math.PI*(radius**2);
    var lengthTank = vt / circle_area;
    var triangle_volume = triangle_area * lengthTank;
    var volume = slice_volume - triangle_volume;
